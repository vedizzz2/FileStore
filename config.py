...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6969391120"))
#Port
...
DB_NAME = os.environ.get("DATABASE_NAME", "nithish7uy")
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "5906206984 7795004397").split()):
        ADMINS.append(int(x))
except ValueError:
