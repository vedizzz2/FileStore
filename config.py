...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7829750752:AAFDkUTCNA-BhInfhKInya8pV6jga_m0CI4")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "27027538"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "a043e6cc3ab0663e08a0f4ba3a7eeafd")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002414898147"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Vedi")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5906206984"))
#Port
...
START_PIC = os.environ.get("START_PIC", "https://graph.org/file/3975ced54de2b62bf7c06-75f1607f41c54ab682.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://graph.org/file/54ff5a900fda2934d26ca-7561527b8520ca66a0.jpg")

# Turn this feature on or off using True or False put value inside  ""
# TRUE for yes FALSE if no 
TOKEN = True if os.environ.get('TOKEN', "True") == "True" else True 
SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "Vipurl.in")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "68b55b079d1e62c8abee194850ee2c2a94083463")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 2000)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","https://t.me/Tamil_LinksZzz/34")


HELP_TXT = "<b><blockquote>ᴛʜɪs ɪs ᴀɴ ғɪʟᴇ ᴛᴏ ʟɪɴᴋ ʙᴏᴛ ᴡᴏʀᴋ ғᴏʀ @Tamil_LinksZzz\n\n❏ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs\n├/start : sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ\n├/about : ᴏᴜʀ Iɴғᴏʀᴍᴀᴛɪᴏɴ\n└/help : ʜᴇʟᴘ ʀᴇʟᴀᴛᴇᴅ ʙᴏᴛ\n\n sɪᴍᴘʟʏ ᴄʟɪᴄᴋ ᴏɴ ʟɪɴᴋ ᴀɴᴅ sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴊᴏɪɴ ʙᴏᴛʜ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ ᴛʜᴀᴛs ɪᴛ.....!\n\n ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ <a href=https://t.me/Tamil_LinksZzz>sᴜʙᴀʀᴜ</a></blockquote></b>"
